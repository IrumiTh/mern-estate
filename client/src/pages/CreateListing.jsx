...
export default function createListing() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            if(formData.imageUrls.length < 1) return setError('You must upload at least one photo')
      ...
      <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
        ...
        <div className='flex flex-col flex-1 gap-4'>
            ...
            <div className='flex gap-4'>
                ...
                <button disabled={uploading} type='button' onClick={handleImageSubmit} className='p-3 text-green-700 border-green-700 border rounded upperc hover:shadow-lg disabled:opacity-80'>{uploading? 'Uploading...' : 'Upload'}</button>
